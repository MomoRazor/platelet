...
-   All new development should be done using Typescript were possible.
-   Use Node v18 when contributing on this project.
-   DO NOT delete the package-lock.json. Due to peerDependency issues, regeneration of the package-lock.json will create project breaking issues.
